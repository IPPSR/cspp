...
## Updates:
* **Version 0.2.1** -- Added the `plot_panel` function which facilitates the creation of timeseries plots, similar to [panelView](http://yiqingxu.org/software/panelView/panelView.html). 
...
Finally, the function has the option to produce state-year line graphs. This will work with any variable, but is best when used with a continuous variable.
