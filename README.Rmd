...
-- Added integration with `csppData` to allow use of the most recent CSPP data (vesion 2.4)

**Past Updates** 

-- Added the `corr_plot` function which allows the creation of correlation plots and correlation matrices. 

-- Added the `plot_panel` function which facilitates the creation of timeseries plots, similar to [panelView](http://yiqingxu.org/software/panelView/panelView.html). 
...
```{r}
r# Use get_var_info to generate variable vector inline
...
[**Caleb Lucas**](https://caleblucas.com/) - Ph.D. Candidate, Michigan State University ([Twitter](https://twitter.com/calebjlucas?lang=en)) <br />
[**Josh McCrain**](http://joshuamccrain.com) - Post-doc, IPPSR, Michigan State University ([Twitter](https://twitter.com/joshmccrain?lang=en))
